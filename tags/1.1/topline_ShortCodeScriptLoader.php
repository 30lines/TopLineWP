<?php
/**
 * Topline Shortcode Loader with Scripts
 * Author:   DJF
 * Company:  30Lines
 * Purpose:  Allows us to register shortcodes with custom javascript within the confines of our beautiful plugin
 */
include_once('topline_ShortCodeLoader.php');
 ...
 */
abstract class topline_ShortCodeScriptLoader extends topline_ShortCodeLoader {

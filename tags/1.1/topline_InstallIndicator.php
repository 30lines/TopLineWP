<?php
/**
 * Topline Plugin Install Indicator class
 * Author:   DJF
 * Company:  30Lines
 * Purpose:  Allows the TopLine plugin to know if the plugin has been installed or uninstalled,
 * return server, plugin, or site information, etc. 
 */

include_once('topline_OptionsManager.php');

class topline_InstallIndicator extends topline_OptionsManager {

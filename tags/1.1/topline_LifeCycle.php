<?php
/**
 * Topline Plugin LifeCycle class
 * Author:   DJF
 * Company:  30Lines
 * Purpose:  Provides helper methods and assists the plugin initialization lifecycle
 */
include_once('topline_InstallIndicator.php');

class topline_LifeCycle extends topline_InstallIndicator {

    public $customPostTypes = array('properties', 'floorplans', 'units');

    /**
     * Install plugin dependencies, add actions and filter, etc. General install of plugin
     */
    ...
    /**
     * init options initialization method
     * @return void
     */
    ...
    /**
     * Initialize Custom Post Type Meta Boxes method
     */
    ...
    /**
     * Override to drop plugin-created tables on uninstall.
     * @return void
     */
